...
//and '*', write a function to check whether this string is valid.We define the validity of a string by these rules:
//
...
public static void main(String[] args) {
        ...
        CheckValidString myInstance = new CheckValidString();
        String parentheses = "((";
        myInstance.checkValidString(parentheses);
